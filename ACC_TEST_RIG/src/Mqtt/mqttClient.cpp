 ...
 */
mqttClient::mqttClient(const char * id, const char * host, int port, const char * subscribeTopic,
 ...
 * @return -1 on error, 0 on success
 */
int mqttClient::publish(const char *message) {
 ...
 */
void mqttClient::_onMessage(struct mosquitto *mosq, void *obj,
                            const struct mosquitto_message *msg) {
    //get ref to mqttClient instance
    mqttClient * instance = reinterpret_cast<mqttClient*>(obj);
 ...
 */
void mqttClient::_onSubscribe(struct mosquitto *mosq, void *obj, int mid,
                              int qos_count, const int *granted_qos) {
    //get ref to mqttClient instance
    auto * instance = reinterpret_cast<mqttClient*>(obj);
 ...
 * @param rc - status
 */
void mqttClient::_onConnect(struct mosquitto *mosq, void *obj, int rc) {
    /*
     * status
     * 0 - success
 ...
 */
void mqttClient::_onDisconnect(struct mosquitto *mosq, void *obj, int rc) {
    /*
 ...
 */
void mqttClient::_onLog(struct mosquitto *mosq, void *obj, int rc,
                         const char *msg) {
 ...
 * @param rc - int indication what happened
 */
void mqttClient::_onPublish(struct mosquitto *mosq, void *obj, int rc) {
    //get ref to mqttClient instance
    auto * instance = reinterpret_cast<mqttClient*>(obj);
 ...
 */
void mqttClient::setCallback(IMqttCallback *_icallback) {
 ...
 */
std::thread mqttClient::mqttThread() {
    return std::thread(&mqttClient::worker,this);
}
